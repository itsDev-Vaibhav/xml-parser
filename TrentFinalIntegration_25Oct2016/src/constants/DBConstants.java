...
public class DBConstants {
	...
	//public static String GET_TRANS_E_LOADSHIP="SELECT distinct(TRANSID) from (select count(1),transid,whseid from tl_e_loadship where processflag='0' group by transid, whseid order by count(1) desc) where rownum<2";
	...
	public static String GET_TRANS_E_ASNGRN_WD32="SELECT distinct(TRANSID) FROM TL_E_ASNGRN_WD32 WHERE PROCESSFLAG='0'";
	...
	public static String GET_TL_E_ASNGRN_WD32_HEADER="select HL,EBELN,ASNNO,GRNDAT,LRNO,VENDINV,WHSEID from TL_E_ASNGRN_WD32 where TRANSID=?";
	...
	public static String GET_TL_E_ASNGRN_WD32_DATA="select HL, EBELN, EBELP, MATNR, MENGE, WERKS, LGORT, CONDITIONCODE,R_WERKS,LPN from TL_E_ASNGRN_WD32 where TRANSID=?";
	...
	public static String GET_TL_E_ASNGRN_WD32_UPDT="UPDATE TL_E_ASNGRN_WD32 SET PROCESSFLAG='9' , FILENAME=? ,PROCESSDATE=sysdate where TRANSID= ?";
